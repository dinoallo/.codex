...
variable "vm_template" {
  description = "Clonable Proxmox template identifier accepted by the provider version in use."
  type        = string
...
variable "artifacts_dir" {
  description = "Per-stack output directory for generated key, inventory, and optional snippets."
  type        = string
  default     = ".artifacts"
}
